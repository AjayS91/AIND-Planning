...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            # action Node for this action
            node_a = PgNode_a(action)
            # check if its preconditions is satisfied to make it reachable.
            if node_a.prenodes.issubset(self.s_levels[level]):
                # add it to list of action nodes
                a_nodes.append(node_a)
                # now it is  a child of the preceding level's state nodes
                # the preceding level's state nodes parents of it
    ...
    def add_literal_level(self, level):
        ...
        for node_a in self.a_levels[level - 1]:
            # add the effected node to level's state nodes and now make it a child of the preceding level's state nodes
            # and action node
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # opposite sign of the nodes doesn't cancel each other
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # preconditions of opposite sign of the nodes doesn't cancel each other
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # preconditions are not mutually exclusive
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        # check if two states have opposite sign
        result = (node_s1.symbol == node_s2.symbol and node_s1.is_pos != node_s2.is_pos)
        return result
